...
// Status forced to "Closed" for all entries
const MOCK_DATA = [
  ...
  { ticket_id: "TKT-20260301-000002", source: "Email", tenant_name: "Fortrea", client_name: "Merck", project_key: "PROJ-MRK-DIAB3", project_description: "Type 2 diabetes trial", drug_name: "Humira", therapeutic_indication: "Rheumatoid arthritis", status: "Closed", assigned_user: "Sneha Kapoor", created_at: "2026-03-01T15:00:00" }, // Due Today
...
const TicketsPage = () => {
  ...
  const enrichWithMockDrug = (ticket) => {
    ...
    return {
      ...ticket,
      status: "Closed", // Ensuring status is locked to Closed
  ...
  // Header style for wrapping and compact view
    ...
    <div className="tickets-wrapper">
      ...
      <div className="tickets-table-container">
        <table className="tickets-table" style={{ fontSize: '0.82rem', width: '100%', tableLayout: 'auto' }}>
          <thead>
            <tr>
              <th onClick={() => sortBy("ticket_id")} className="sortable" style={headerStyle}>Ticket ID</th>
              ...
              <th onClick={() => sortBy("created_at")} className="sortable" style={headerStyle}>Creation Timeline</th>
            </tr>
          </thead>
          <tbody>
            {filteredTickets.map((t) => {
              ...
              return (
                <React.Fragment key={t.ticket_id}>
                  <tr onClick={() => toggleExpand(t.ticket_id)} className={`clickable-row ${expired ? "sla-expired-row" : ""}`} style={rowStyle}>
                    <td>{t.ticket_id}</td>
                    <td>{t.source}</td>
                    ...
                    <td style={{ lineHeight: '1.2', padding: '4px' }}>
                          ...
                          {docCategory && (
                            <div className="mini-document-section">
                              <div className="document-pills-container">
                                ...
                                )) : <p className="no-docs-text">No files found.</p>}
                              </div>
                            </div>
                          )}
                        </div>
