...
// Status locked to "Closed". Dates set relative to March 4, 2026.
const MOCK_DATA = [
  { ticket_id: "TKT-20260302-000001", source: "Email", tenant_name: "Fortrea", client_name: "GSK", project_key: "PROJ-GSK-IMMUNO2", project_description: "Oncology immunotherapy study", drug_name: "Lipitor", therapeutic_indication: "High cholesterol", status: "Closed", assigned_user: "Rohan Mehta", created_at: "2026-03-02T09:00:00" }, // Due Today (~52h ago)
  { ticket_id: "TKT-20260301-000002", source: "Email", tenant_name: "Fortrea", client_name: "Merck", project_key: "PROJ-MRK-DIAB3", project_description: "Type 2 diabetes trial", drug_name: "Humira", therapeutic_indication: "Rheumatoid arthritis", status: "Closed", assigned_user: "Sneha Kapoor", created_at: "2026-03-01T15:00:00" }, // Due Today (~70h ago)
...
const TicketsPage = () => {
  ...
  // Styling for wrapped headers and table frame consistency
  const headerStyle = { whiteSpace: 'normal', wordWrap: 'break-word', lineHeight: '1.1', padding: '6px 4px', verticalAlign: 'middle' };
    ...
    <div className="tickets-wrapper">
      ...
      <div className="dashboard-controls">
        <div className="search-container">
          <input type="text" placeholder="Search Ticket ID, Study..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="search-input" />
      ...
      <div className="tickets-table-container">
        <table className="tickets-table" style={{ fontSize: '0.82rem', width: '100%', tableLayout: 'auto' }}>
          <thead>
            <tr>
